...
public:
    CMainParams() {
        ...
        consensus.nMinimumChainWork = uint256S("0x000000000000000000000000000000000000000000000000011da6f1a23f3d28");
        ...
        chainTxData = ChainTxData{
            1594685351, // * UNIX timestamp of last known number of transactions
            26642,      // * total number of transactions between genesis and that timestamp
